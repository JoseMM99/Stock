...
<img style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;"><table class="s-3 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
 <tbody>
<tr>
...
<div style="border-top-width: 5px; border-top-color: #50BF9C; border-top-style: solid;">
...
<tr>
 <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
<img class="" width="100" height="100" src="https://www.euskodata.com/wp-content/uploads/2019/03/areas-grandes-empresas.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
</td>
</tr>
 </tbody>
</table>

 <h4 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 24px; line-height: 28.8px;" align="center">Bienvenido a Prueba de correo</h4>
 <h5 class="text-muted text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: #636c72; vertical-align: baseline; font-size: 20px; line-height: 24px;" align="center">{{ $user->name}} </h5>
...
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 1px; border-top-color: #dddddd; border-top-style: solid; height: 1px; width: 100%; margin: 0;" align="left"></td>
 ...
 <h5 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 20px; line-height: 24px;" align="center"><strong>Verificación de cuenta.</strong></h5>
...
<tbody>
 <tr>
<td style="border-top-width: 0; border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-color: #e9ecef; border-top-style: solid; margin: 0; padding: 12px;" align="left" valign="top">Correo electrónico:</td>
<td style="border-top-width: 0; border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-color: #e9ecef; border-top-style: solid; margin: 0; padding: 12px;" class="text-right" align="right" valign="top">{{ $user->email }} </td>
 </tr>
</tbody>
 </table>

 <img width="556" height="322" class="img-fluid" src="https://www.euskodata.com/wp-content/uploads/2019/03/areas-grandes-empresas.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 100%; border: 0 none;">
</div>
 </td>
</tr>
 </tbody>
...
<tr>
 <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
<img width="50" height="50" class="" src="https://img.icons8.com/color/48/000000/info--v1.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
</td>
</tr>
 </tbody>
</table>

 <h4 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 24px; line-height: 28.8px;" align="center">Para acceder al sistema</h4>
 <p class="text-center" style="line-height: 24px; font-size: 16px; margin: 0;" align="center">Se requiere validar su cuenta</p>
...
<table class="btn btn-primary btn-lg mx-auto " align="center" border="0" cellpadding="0" cellspacing="0" style="font-family: Helvetica, Arial, sans-serif; mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-spacing: 0px; border-collapse: separate !important; border-radius: 4px; margin: 0 auto;">
 <tbody>
<tr>
 <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-radius: 4px; margin: 0;" align="center" bgcolor="#50BF9C">
<a href="http://127.0.0.1:8000/api/validar?email={{$user->email}}&validar={{$user->validation}}" style="font-size: 20px; font-family: Helvetica, Arial, sans-serif; text-decoration: none; border-radius: 4.8px; line-height: 30px; display: inline-block; font-weight: normal; white-space: nowrap; background-color: #50BF9C; color: #ffffff; padding: 8px 16px; border: 1px solid #50BF9C;">Favor de verificar su correo</a>
 </td>
</tr>
 </tbody>
</table>
...
<tr>
 ...
 <div class="text-center text-muted" style="color: #636c72;" align="center">Esto es un correo de prueba</div>
 <div class="text-center text-muted" style="color: #636c72;" align="center">Prueba para desarrollador Backend (Laravel)</div>
 <div class="text-center text-muted " style="color: #636c72;" align="center">Para logeo de empleados y CRUD de productos</div>
<table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
 <tbody>
<tr>
 <td height="24" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 24px; width: 100%; height: 24px; margin: 0;" align="left">
...
<tbody>
 <tr>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">Cel.271 172 0699 </td>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">
 ...
 <tr>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">Correo: 20183l301014@utcv.edu.mx</td>
 </tr>
 <tr>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">Facebook: Jose Mendoza</td>
 </tr>
</tbody>
 </table>
<table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
